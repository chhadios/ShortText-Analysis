  ...
  return (
    <li className={`accordion_item ${clicked ? "active" : ""}`}>
      <button className="button" onClick={handleToggle}>
       <div style={{width:"30%"}}>{faq.text}({faq.sentiments})
       <p style={{fontSize:"13px",fontStyle:"italic",fontWeight:"normal"}}>Any end user description Mentioned in the Reviews</p>
       </div>
